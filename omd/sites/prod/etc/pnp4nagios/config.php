...
#
$conf['rrdtool'] = "/omd/sites/prod/bin/rrdtool";
#
...
#
$conf['rrdbase'] = "/omd/sites/prod/var/pnp4nagios/perfdata/";
#
# Location of "page" configs
#
$conf['page_dir'] = "/omd/sites/prod/etc/pnp4nagios/pages/";
#
...
# 
$conf['livestatus_socket'] = "unix:/omd/sites/prod/tmp/run/live";
...
#
$conf['background_pdf'] = '/omd/sites/prod/etc/pnp4nagios/background.pdf' ;
#
# Enable Calendar
#
$conf['use_calendar'] = 1;
...
$conf['RRD_DAEMON_OPTS'] = 'unix:/omd/sites/prod/tmp/run/rrdcached.sock';
...
# First match wins!
$conf['template_dirs'][] = '/omd/sites/prod/etc/pnp4nagios/templates';
$conf['template_dirs'][] = '/omd/sites/prod/local/share/check_mk/pnp-templates'; 
$conf['template_dirs'][] = '/omd/sites/prod/share/check_mk/pnp-templates';
$conf['template_dirs'][] = '/omd/sites/prod/share/pnp4nagios/htdocs/templates';
$conf['template_dirs'][] = '/omd/sites/prod/share/pnp4nagios/htdocs/templates.dist';

#
# Directory to search for special templates
#
$conf['special_template_dir'] = '/omd/sites/prod/etc/pnp4nagios/templates.special';
