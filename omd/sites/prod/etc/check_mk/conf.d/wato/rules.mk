...
ignored_services = [
  ( [], ['mgen1.gate.rtf'], [u'IPMI Sensor Summary$'], {'description': u'disable IPMI until working'} ),
  ( [], ['mgen2.gate.rtf'], [u'IPMI Sensor Summary$'], {'description': u'disable IPMI until working'} ),
  ( [], ['pgen1.gate.rtf'], [u'IPMI Sensor Summary$'], {'description': u'disable IPMI until working'} ),
  ( [], ['pgen2.gate.rtf'], [u'IPMI Sensor Summary$'], {'description': u'disable IPMI until working'} ),
] + ignored_services
