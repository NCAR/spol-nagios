...
# Checks for control1.gate.rtf

def get_precompiled_check_table(hostname, remove_duplicates=False, world='config'):
    return [('local', u'ANT_Antenna_Door_Open_Fault', None, u'ANT_Antenna_Door_Open_Fault', ''), ('local', u'ANT_Az_Run_Line_Active', None, u'ANT_Az_Run_Line_Active', ''), ('local', u'ANT_Azimuth_Brake_Bypass_Fault', None, u'ANT_Azimuth_Brake_Bypass_Fault', ''), ('local', u'ANT_Azimuth_Brakes_Fault', None, u'ANT_Azimuth_Brakes_Fault', ''), ('local', u'ANT_Azimuth_Fans_Fault', None, u'ANT_Azimuth_Fans_Fault', ''), ('local', u'ANT_Azimuth_Stowed_Fault', None, u'ANT_Azimuth_Stowed_Fault', ''), ('local', u'ANT_Azimuth_Temperature_Fault', None, u'ANT_Azimuth_Temperature_Fault', ''), ('local', u'ANT_COHO_Gate_Fault', None, u'ANT_COHO_Gate_Fault', ''), ('local', u'ANT_Circulator_Temperature_Fault', None, u'ANT_Circulator_Temperature_Fault', ''), ('local', u'ANT_El_Run_Line_Active', None, u'ANT_El_Run_Line_Active', ''), ('local', u'ANT_Elevation_Brake_Bypass_Fault', None, u'ANT_Elevation_Brake_Bypass_Fault', ''), ('local', u'ANT_Elevation_Brakes_Fault', None, u'ANT_Elevation_Brakes_Fault', ''), ('local', u'ANT_Elevation_Fans_Fault', None, u'ANT_Elevation_Fans_Fault', ''), ('local', u'ANT_Elevation_Limit_Fault', None, u'ANT_Elevation_Limit_Fault', ''), ('local', u'ANT_Elevation_Stowed_Fault', None, u'ANT_Elevation_Stowed_Fault', ''), ('local', u'ANT_Elevation_Temperature_Fault', None, u'ANT_Elevation_Temperature_Fault', ''), ('local', u'ANT_Mitch_Switch_Fault', None, u'ANT_Mitch_Switch_Fault', ''), ('local', u'ANT_Oil_Pressure_Fault', None, u'ANT_Oil_Pressure_Fault', ''), ('local', u'ANT_Pedestal_Switch_Disabled_Fault', None, u'ANT_Pedestal_Switch_Disabled_Fault', ''), ('local', u'ANT_RF_Disabled_Fault', None, u'ANT_RF_Disabled_Fault', ''), ('local', u'ANT_RF_Ladder_Lockout_Fault', None, u'ANT_RF_Ladder_Lockout_Fault', ''), ('local', u'ANT_Wave_Guide_Pressure_Fault', None, u'ANT_Wave_Guide_Pressure_Fault', ''), ('local', u'ANT_Wave_Guide_Switch_Fault', None, u'ANT_Wave_Guide_Switch_Fault', ''), ('cpu.loads', None, (5.0, 10.0), u'CPU load', ''), ('kernel.util', None, {}, u'CPU utilization', ''), ('diskstat', u'SUMMARY', {}, u'Disk IO SUMMARY', ''), ('df', u'/', {'trend_range': 24, 'show_levels': 'onmagic', 'inodes_levels': (10.0, 5.0), 'magic_normsize': 20, 'show_inodes': 'onlow', 'levels': (80.0, 90.0), 'show_reserved': False, 'levels_low': (50.0, 60.0), 'trend_perfdata': True}, u'Filesystem /', ''), ('df', u'/data', {'trend_range': 24, 'show_levels': 'onmagic', 'inodes_levels': (10.0, 5.0), 'magic_normsize': 20, 'show_inodes': 'onlow', 'levels': (80.0, 90.0), 'show_reserved': False, 'levels_low': (50.0, 60.0), 'trend_perfdata': True}, u'Filesystem /data', ''), ('df', u'/home', {'trend_range': 24, 'show_levels': 'onmagic', 'inodes_levels': (10.0, 5.0), 'magic_normsize': 20, 'show_inodes': 'onlow', 'levels': (80.0, 90.0), 'show_reserved': False, 'levels_low': (50.0, 60.0), 'trend_perfdata': True}, u'Filesystem /home', ''), ('local', u'HP_DataMapper_primary', None, u'HP_DataMapper_primary', ''), ('local', u'HP_DsFileDist_ext_data', None, u'HP_DsFileDist_ext_data', ''), ('local', u'HP_DsServerMgr_primary', None, u'HP_DsServerMgr_primary', ''), ('local', u'HP_Fmq2Fmq_monitoring', None, u'HP_Fmq2Fmq_monitoring', ''), ('local', u'HP_InputWatcher_spol_cams', None, u'HP_InputWatcher_spol_cams', ''), ('local', u'HP_Janitor_logs', None, u'HP_Janitor_logs', ''), ('local', u'HP_Janitor_sysview', None, u'HP_Janitor_sysview', ''), ('local', u'HP_LdataWatcher_sysview', None, u'HP_LdataWatcher_sysview', ''), ('local', u'HP_Scout_primary', None, u'HP_Scout_primary', ''), ('local', u'HP_SpolMonCtrl_ops', None, u'HP_SpolMonCtrl_ops', ''), ('local', u'HawkSummary_Data', None, u'HawkSummary_Data', ''), ('local', u'HawkSummary_Processes', None, u'HawkSummary_Processes', ''), ('lnx_if', u'2', {'state': ['1'], 'errors': (0.01, 0.1), 'speed': 1000000000}, u'Interface 2', ''), ('lnx_if', u'3', {'state': ['1'], 'errors': (0.01, 0.1), 'speed': 1000000000}, u'Interface 3', ''), ('kernel', u'Context Switches', None, u'Kernel Context Switches', ''), ('kernel', u'Major Page Faults', None, u'Kernel Major Page Faults', ''), ('kernel', u'Process Creations', None, u'Kernel Process Creations', ''), ('logins', None, (20, 30), u'Logins', ''), ('mem.linux', None, {'levels_total': ('perc_used', (120.0, 150.0)), 'levels_shm': ('perc_used', (20.0, 30.0)), 'levels_commitlimit': ('perc_free', (20.0, 10.0)), 'levels_virtual': ('perc_used', (80.0, 90.0)), 'levels_vmalloc': ('abs_free', (52428800, 31457280)), 'levels_committed': ('perc_used', (100.0, 150.0)), 'levels_pagetables': ('perc_used', (8.0, 16.0))}, u'Memory', ''), ('mounts', u'/', [u'attr2', u'inode64', u'noquota', u'relatime', u'rw'], u'Mount options of /', ''), ('mounts', u'/data', [u'data=ordered', u'relatime', u'rw'], u'Mount options of /data', ''), ('mounts', u'/home', [u'data=ordered', u'relatime', u'rw'], u'Mount options of /home', ''), ('chrony', None, {'ntp_levels': (10, 200.0, 500.0), 'alert_delay': (300, 3600)}, u'NTP Time', ''), ('cpu.threads', None, (2000, 4000), u'Number of threads', ''), ('omd_apache', u'prod', None, u'OMD prod apache', ''), ('livestatus_status', u'prod', {'site_stopped': 2, 'process_performance_data': 1, 'check_external_commands': 2, 'execute_host_checks': 2, 'check_service_freshness': 1, 'accept_passive_host_checks': 2, 'enable_flap_detection': 1, 'check_host_freshness': 0, 'accept_passive_service_checks': 2, 'enable_event_handlers': 1, 'enable_notifications': 2, 'execute_service_checks': 2}, u'OMD prod performance', ''), ('omd_status', u'prod', None, u'OMD prod status', ''), ('local', u'PM_AC_Power', None, u'PM_AC_Power', ''), ('local', u'PM_Frequency', None, u'PM_Frequency', ''), ('local', u'PM_Source_Switched', None, u'PM_Source_Switched', ''), ('local', u'PM_TotalKW', None, u'PM_TotalKW', ''), ('local', u'PM_VoltageA', None, u'PM_VoltageA', ''), ('local', u'PM_VoltageB', None, u'PM_VoltageB', ''), ('local', u'PM_VoltageC', None, u'PM_VoltageC', ''), ('local', u'PM_XmitPowerDbmH', None, u'PM_XmitPowerDbmH', ''), ('local', u'PM_XmitPowerDbmTxTop', None, u'PM_XmitPowerDbmTxTop', ''), ('local', u'PM_XmitPowerDbmV', None, u'PM_XmitPowerDbmV', ''), ('postfix_mailq', None, {'active': (200, 300), 'deferred': (10, 20)}, u'Postfix Queue', ''), ('tcp_conn_stats', None, {}, u'TCP Connections', ''), ('local', u'TEMP_Annex', None, u'TEMP_Annex', ''), ('local', u'TEMP_CIRC-H', None, u'TEMP_CIRC-H', ''), ('local', u'TEMP_CIRC-V', None, u'TEMP_CIRC-V', ''), ('local', u'TEMP_Klystron', None, u'TEMP_Klystron', ''), ('local', u'TEMP_KlystronBody', None, u'TEMP_KlystronBody', ''), ('local', u'TEMP_KlystronExhaust', None, u'TEMP_KlystronExhaust', ''), ('local', u'TEMP_LNA-H', None, u'TEMP_LNA-H', ''), ('local', u'TEMP_LNA-V', None, u'TEMP_LNA-V', ''), ('local', u'TEMP_RX-enclosure', None, u'TEMP_RX-enclosure', ''), ('local', u'TEMP_RX-plate', None, u'TEMP_RX-plate', ''), ('local', u'TEMP_Rear_Wall', None, u'TEMP_Rear_Wall', ''), ('local', u'TEMP_SCC', None, u'TEMP_SCC', ''), ('local', u'TEMP_TP-enclosure', None, u'TEMP_TP-enclosure', ''), ('local', u'TEMP_TX-coupler-H', None, u'TEMP_TX-coupler-H', ''), ('local', u'TEMP_UPS_Container', None, u'TEMP_UPS_Container', ''), ('local', u'TX_Cabinet_Air_Temperature_Fault', None, u'TX_Cabinet_Air_Temperature_Fault', ''), ('local', u'TX_Cabinet_Airflow_Fault', None, u'TX_Cabinet_Airflow_Fault', ''), ('local', u'TX_Cabinet_Interlock_Fault', None, u'TX_Cabinet_Interlock_Fault', ''), ('local', u'TX_Charging_System_Fail_Fault', None, u'TX_Charging_System_Fail_Fault', ''), ('local', u'TX_Circulator_Temperature_Fault', None, u'TX_Circulator_Temperature_Fault', ''), ('local', u'TX_Filament_PS_Voltage_Fault', None, u'TX_Filament_PS_Voltage_Fault', ''), ('local', u'TX_Filament_ps_Fault', None, u'TX_Filament_ps_Fault', ''), ('local', u'TX_Focus_Coil_Airflow_Fault', None, u'TX_Focus_Coil_Airflow_Fault', ''), ('local', u'TX_Focus_Coil_Current_Fault', None, u'TX_Focus_Coil_Current_Fault', ''), ('local', u'TX_Focus_Coil_PS_Voltage_Fault', None, u'TX_Focus_Coil_PS_Voltage_Fault', ''), ('local', u'TX_Inverse_Diode_Current_HV_Fault', None, u'TX_Inverse_Diode_Current_HV_Fault', ''), ('local', u'TX_Klystron_Air_Temperature_Fault', None, u'TX_Klystron_Air_Temperature_Fault', ''), ('local', u'TX_Klystron_Airflow_Fault', None, u'TX_Klystron_Airflow_Fault', ''), ('local', u'TX_Klystron_Current_Fault', None, u'TX_Klystron_Current_Fault', ''), ('local', u'TX_Klystron_Filament_Current_Fault', None, u'TX_Klystron_Filament_Current_Fault', ''), ('local', u'TX_Klystron_Vacuum_Pump_Current_Fault', None, u'TX_Klystron_Vacuum_Pump_Current_Fault', ''), ('local', u'TX_Klystron_Warmup_Fault', None, u'TX_Klystron_Warmup_Fault', ''), ('local', u'TX_M15_VDC_PS_Fault', None, u'TX_M15_VDC_PS_Fault', ''), ('local', u'TX_Main_Power_Voltage_Fault', None, u'TX_Main_Power_Voltage_Fault', ''), ('local', u'TX_Maintenance_Required_Fault', None, u'TX_Maintenance_Required_Fault', ''), ('local', u'TX_Modulator_Inverse_Current_Fault', None, u'TX_Modulator_Inverse_Current_Fault', ''), ('local', u'TX_Modulator_Overload_Fault', None, u'TX_Modulator_Overload_Fault', ''), ('local', u'TX_Modulator_Switch_Fail_Fault', None, u'TX_Modulator_Switch_Fail_Fault', ''), ('local', u'TX_Modulator_Switch_Maintenance_Fault', None, u'TX_Modulator_Switch_Maintenance_Fault', ''), ('local', u'TX_P15_VDC_PS_Fault', None, u'TX_P15_VDC_PS_Fault', ''), ('local', u'TX_P28_VDC_PS_Fault', None, u'TX_P28_VDC_PS_Fault', ''), ('local', u'TX_P45_VDC_PS_Fault', None, u'TX_P45_VDC_PS_Fault', ''), ('local', u'TX_P5_VDC_PS_Fault', None, u'TX_P5_VDC_PS_Fault', ''), ('local', u'TX_PRF_Limit_Fault', None, u'TX_PRF_Limit_Fault', ''), ('local', u'TX_Post_Charge_Regulator_Fault', None, u'TX_Post_Charge_Regulator_Fault', ''), ('local', u'TX_Spectrum_Filter_Pressure_Fault', None, u'TX_Spectrum_Filter_Pressure_Fault', ''), ('local', u'TX_Transmitter_Avail_Fault', None, u'TX_Transmitter_Avail_Fault', ''), ('local', u'TX_Transmitter_Battery_Charging_Fault', None, u'TX_Transmitter_Battery_Charging_Fault', ''), ('local', u'TX_Transmitter_Oil_Level_Fault', None, u'TX_Transmitter_Oil_Level_Fault', ''), ('local', u'TX_Transmitter_Oil_Temperature_Fault', None, u'TX_Transmitter_Oil_Temperature_Fault', ''), ('local', u'TX_Transmitter_Overcurrent_Fault', None, u'TX_Transmitter_Overcurrent_Fault', ''), ('local', u'TX_Transmitter_Overvoltage_Fault', None, u'TX_Transmitter_Overvoltage_Fault', ''), ('local', u'TX_Transmitter_Spare_0_Fault', None, u'TX_Transmitter_Spare_0_Fault', ''), ('local', u'TX_Transmitter_Spare_1_Fault', None, u'TX_Transmitter_Spare_1_Fault', ''), ('local', u'TX_Trigger_Amplifier_Fault', None, u'TX_Trigger_Amplifier_Fault', ''), ('local', u'TX_Vacuum_Pump_PS_Voltage_Fault', None, u'TX_Vacuum_Pump_PS_Voltage_Fault', ''), ('local', u'TX_W_G_PFN_Transfer_Interlock_Fault', None, u'TX_W_G_PFN_Transfer_Interlock_Fault', ''), ('local', u'TX_Waveguide_Arc_VSWR_Fault', None, u'TX_Waveguide_Arc_VSWR_Fault', ''), ('local', u'TX_Waveguide_Pressure_Humidity_Fault', None, u'TX_Waveguide_Pressure_Humidity_Fault', ''), ('local', u'TX_Waveguide_Switch_Position_Fault', None, u'TX_Waveguide_Switch_Position_Fault', ''), ('local', u'UPSB_Alarms', None, u'UPSB_Alarms', ''), ('local', u'UPSB_BatteryState', None, u'UPSB_BatteryState', ''), ('local', u'UPSB_OutputState', None, u'UPSB_OutputState', ''), ('local', u'UPS_Alarms', None, u'UPS_Alarms', ''), ('local', u'UPS_BatteryState', None, u'UPS_BatteryState', ''), ('local', u'UPS_BatteryVoltage', None, u'UPS_BatteryVoltage', ''), ('local', u'UPS_OutputState', None, u'UPS_OutputState', ''), ('uptime', None, {}, u'Uptime', ''), ('local', u'WG_PressurePSI', None, u'WG_PressurePSI', ''), ('local', u'WG_RH', None, u'WG_RH', ''), ('local', u'WG_TempC', None, u'WG_TempC', ''), ('local', u'WX_RH', None, u'WX_RH', ''), ('local', u'WX_hailIntensityHitsPerCm2', None, u'WX_hailIntensityHitsPerCm2', ''), ('local', u'WX_heatingTempC', None, u'WX_heatingTempC', ''), ('local', u'WX_heatingVoltage', None, u'WX_heatingVoltage', ''), ('local', u'WX_pressureHpa', None, u'WX_pressureHpa', ''), ('local', u'WX_rainRateMmPerHr', None, u'WX_rainRateMmPerHr', ''), ('local', u'WX_supplyVoltage', None, u'WX_supplyVoltage', ''), ('local', u'WX_tempC', None, u'WX_tempC', ''), ('local', u'WX_windDirnDeg', None, u'WX_windDirnDeg', ''), ('local', u'WX_windSpeedMps', None, u'WX_windSpeedMps', ''), ('local', u'XMIT_High_Voltage_Power', None, u'XMIT_High_Voltage_Power', ''), ('local', u'XMIT_Panel_Power', None, u'XMIT_Panel_Power', '')]
...
# /omd/sites/prod/share/check_mk/checks/omd_apache
...
# /omd/sites/prod/share/check_mk/checks/livestatus_status
...
def check_livestatus_status(item, params, parsed):
    ...
    this_time = time.time()
    status_counters = [
        (1, True, "%.1f/s", "host_checks",    "Host Checks",         ),
        (1, True, "%.1f/s", "service_checks", "Service Checks",      ),
        (1, True, "%.1f/s", "forks",          "Process Creations",   ),
        (1, True, "%.1f/s", "connections",    "Livestatus Connects", ),
        (1, True, "%.1f/s", "requests",       "Livestatus Requests", ),
        (1, True, "%.1f/s", "log_messages",   "Log Messages",        ),
    ]
...
# /omd/sites/prod/share/check_mk/checks/omd_status
...
try:
    sys.exit(do_check('control1.gate.rtf', '192.168.4.2'))
except SystemExit, e:
    sys.exit(e.code)
except Exception, e:
