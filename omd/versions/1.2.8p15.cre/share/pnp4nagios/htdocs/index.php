...
define('PNP_ETC_PATH' , '/omd/versions/1.2.8p15.cre/etc/pnp4nagios');
define('PNP_LOG_PATH' , '/omd/versions/1.2.8p15.cre/var/pnp4nagios');
 ...
 * This path can be absolute or relative to this file.
 */
$kohana_system = '/omd/versions/1.2.8p15.cre/lib/kohana/system';
