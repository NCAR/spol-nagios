...
use lib '/omd/versions/1.2.8p15.cre/lib/perl5/lib/perl5';
...
my %conf = (
    TIMEOUT            => 15,
    CFG_DIR            => "/omd/versions/1.2.8p15.cre/etc/pnp4nagios/",
    USE_RRDs           => 1,
    RRDPATH            => "/omd/versions/1.2.8p15.cre/var/pnp4nagios/perfdata",
    RRDTOOL            => "/bin/true",
    RRD_STORAGE_TYPE   => "SINGLE",
    RRD_HEARTBEAT      => 8640,
    RRA_STEP           => 60,
    RRA_CFG            => "/omd/versions/1.2.8p15.cre/etc/pnp4nagios/rra.cfg",
    STATS_DIR          => "/omd/versions/1.2.8p15.cre/var/pnp4nagios/stats",
    LOG_FILE           => "/omd/versions/1.2.8p15.cre/var/pnp4nagios/log/perfdata.log",
    ...
    KEY_FILE           => '/omd/versions/1.2.8p15.cre/etc/pnp4nagios/secret.key',
...
sub print_help {
  ...
  Options:
    ...
    Default: /omd/versions/1.2.8p15.cre/etc/pnp4nagios/process_perfdata.cfg
